...
class PageSeo
{
    ...
    #[ORM\Column(length: 255)]
    private ?string $financeListPageDescription = null;
    ...
    public function getFinanceListPageDescription(): ?string
    {
        return $this->financeListPageDescription;
    }

    public function setFinanceListPageDescription(string $financeListPageDescription): static
    {
        $this->financeListPageDescription = $financeListPageDescription;
